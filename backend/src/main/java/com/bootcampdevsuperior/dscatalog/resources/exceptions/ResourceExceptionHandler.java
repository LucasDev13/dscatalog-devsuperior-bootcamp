package com.bootcampdevsuperior.dscatalog.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<?> entityNotFound(ResourceNotFoundException e, HttpServletRequest request){
